...
- [ ] **luffy/verl/verl/protocol.py:116** - Optimize memory usage during tensor reshaping
- [ ] **luffy/verl/verl/protocol.py:117** - Add support for different tensor types and shapes
